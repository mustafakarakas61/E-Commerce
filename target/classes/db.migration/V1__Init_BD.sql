...
alter table if exists orders_order_items add constraint FK3l8rktw0f4w5t6tift31e2d7c foreign key (order_entity_id) references orders;
...
alter table if exists product_reviews add constraint FK7k3k0ru1omu7xdtdamtrl276 foreign key (product_entity_id) references product;
